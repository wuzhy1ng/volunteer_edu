...
urlpatterns = [
    ...
    path('search/', views.search),  # 志愿者信息索引
    path('search/detail/', views.search_detail),  # 志愿者详细信息

    path('forget/', views.forget),  # 忘记密码
    path('forget/sms/', views.forget_sms),  # 忘记密码验证码

    path('feedback/', views.feedback),  # 忘记密码验证码
